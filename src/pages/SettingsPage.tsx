...
export const SettingsPage = () => {
  const { llmProvider, temperature, updateSettings, notifications } =
    useSettingsStore();
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                value="System Admin"
                className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2 text-slate-400 outline-none"
                readOnly
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 mb-3">
                Controls how the AI balances factual product representation with
                creative styling when generating campaign assets.
              </p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              >
                <div
                  className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${notifications.email ? "right-1" : "left-1"}`}
                ></div>
              </button>
            </div>
            <div className="flex items-center justify-between">
              ...
              >
                <div
                  className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${notifications.push ? "right-1" : "left-1"}`}
                ></div>
              </button>
            </div>
          </div>
      ...
      <div className="flex justify-end gap-4 pt-4">
        <button
          onClick={() => {
            ...
            setTimeout(() => {
              if (btn) btn.innerText = "Save Configuration";
            }, 2000);
          }}
          id="save-btn"
